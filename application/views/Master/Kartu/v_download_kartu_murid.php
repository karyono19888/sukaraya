	...
	<section>
		<div id="front">
			<div style="position: absolute;">
				<img src="upload/murid/<?= $card['murid_image']; ?>"
					style="width: 80px; height: 100px; margin-top:55px; border: 1px solid #4BB39A;  padding: 4px;" />
			</div>
			<div class="name">
				<b class="nama-karyawan" style="font-size:12px;"><?= $card['murid_nama']; ?></b><br>
				<small class="jabatan" style="font-size:8px; letter-spacing:3px;">MURID</small>
			</div>
			<small style="font-size:6px; letter-spacing:3px; margin-top:10px;">ID :
				<?= $card['murid_kartu_id']; ?></small>
			<div>
				<div class="background">
					<img src="<?= base_url('upload'); ?>/barcode/<?= $card['murid_barcode']; ?>" alt="barcode"
