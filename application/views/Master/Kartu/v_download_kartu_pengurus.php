	...
	<section>
		<div id="front">
			<div style="position: absolute;">
				<img src="upload/pengurus/<?= $card['pengurus_image']; ?>"
					style="width: 80px; height: 100px; margin-top:55px; border: 1px solid #4BB39A;  padding: 4px;" />
			</div>
			<div class="name">
				<b class="nama-karyawan" style="font-size:12px;"><?= $card['pengurus_nama']; ?></b><br>
				<small class="jabatan" style="font-size:8px; letter-spacing:3px;">PENGURUS</small>
			</div>
			<small style="font-size:6px; letter-spacing:3px; margin-top:10px;">ID :
				<?= $card['pengurus_id_card']; ?></small>
			<div>
				<div class="background">
					<img src="<?= base_url('upload'); ?>/barcode/<?= $card['pengurus_barcode']; ?>" alt="barcode"
