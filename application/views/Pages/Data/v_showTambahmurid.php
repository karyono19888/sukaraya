...
<body>
						...
						<div class="card">
                            ...
                            <form method="POST" id="formModalUser">
								<div class="mb-1">
									...
									<input type="hidden" class="form-control" id="murid_kartu_id" name="murid_kartu_id" value="<?= $kode; ?>" />
								</div>
								<div class="mb-1">
								...
								<div class="mb-1">
									...
									<input type="date" class="form-control" id="murid_tgl_lahir" name="murid_tgl_lahir"
									/>
								</div>
								<div class="mb-1">
    ...
    $(document).on("click", "#ModalButtonSimpan", function() {
        if (validasi()) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= site_url('Pages/Data/Murid/Tambah') ?>',
                data: data,
				beforeSend: function() {
