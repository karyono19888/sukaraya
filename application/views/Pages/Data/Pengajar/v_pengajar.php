	...
	<div id="root">
		...
		<main>
			<div class="container">
				...
				<div class="page-title-container">
					<div class="row">
						...
						<div class="col-12 col-md-7">
							<h1 class="mb-0 pb-0 display-4" id="title">Pengajar</h1>
				...
				<!-- Content Start -->
				<a href="<?= base_url('Pages/Data/Pengajar/ShowTambah');?>" type="button" class="btn btn-outline-primary btn-icon btn-icon-start mb-3" id="Tambah" onclick="Tambah()">
								...
								<div class="table-responsive">
									<table id="table" class="table table-hover">
										...
										<tbody>
											<?php
											$i=1;
													foreach($pengajar->result_array() as $a):
												?>
											<tr>
												<td><?= $i++; ?></td>
												...
												<td>
													<div class="d-flex align-items-center me-3">
														...
														<div class="d-inline-block">
															...
															<div class="text-muted text-small"><?= $a['pengajar_jk']; ?>
															</div>
														</div>
													</div>
												</td>
												...
												<td>
													...
													<span class="badge bg-primary text-uppercase"><?= $a['pengajar_status']; ?></span>
													<?php else: ?>
													<span class="badge bg-danger text-uppercase"><?= $a['pengajar_status']; ?></span>
													<?php endif; ?>
												</td>
												<td>
													<a href="<?= base_url('Pages/Data/Pengajar/ShowEditPengajar/'.$a['pengajar_id'].'')?>" class="btn btn-sm btn-icon btn-icon-start btn-outline-warning ms-1 Edit"
														type="button">
													...
													<button class="btn btn-sm btn-icon btn-icon-start btn-outline-danger ms-1 Hapus"
														type="button" data-id="<?= $a['pengajar_id'];?>">
		...
		$(document).on("click", ".Hapus", function() {
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					$.ajax({
						type: 'POST',
						url: '<?= site_url('Pages/Data/Pengajar/Hapus') ?>',
						data: {
							id: id
						},
