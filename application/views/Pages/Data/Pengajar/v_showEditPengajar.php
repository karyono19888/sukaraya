...
<body>
				...
				<div class="page-title-container">
					<div class="row">
						...
						<div class="col-12">
							...
							<h1 class="mb-0 pb-0 display-4" id="title">Edit Pengajar Baru</h1>
							<nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
								<ul class="breadcrumb pt-0">
									<li class="breadcrumb-item"><a href="#">Pages</a></li>
									<li class="breadcrumb-item"><a href="#">Data</a></li>
									<li class="breadcrumb-item"><a href="#">Pengajar</a></li>
									<li class="breadcrumb-item"><a href="#">Edit Pengajar Baru</a></li>
								</ul>
							</nav>
						</div>
						<!-- Title End -->
					...
					<div class="col-sm-6">
						<div class="card">
                            <div class="card-header">
                                NO ID : <b><?= $data['pengajar_id_card']; ?></b>
                            </div>
							<div class="card-body">
                            <form method="POST" id="formModalUser">
								<div class="mb-1">
									...
									<input type="text" class="form-control" id="pengajar_nama" name="pengajar_nama"
										placeholder="Nama Lengkap" value="<?= $data['pengajar_nama']; ?>"/>
									<input type="hidden" class="form-control" id="pengajar_id_card" name="pengajar_id_card" value="<?= $data['pengajar_id_card']; ?>" />
								</div>
								<div class="mb-1">
									<label class="form-label">Jenis Kelamin</label>
									<select id="pengajar_jk" name="pengajar_jk" class="form-control" select2>
									<option value="<?= $data['pengajar_jk']; ?>"><?= $data['pengajar_jk']; ?></option>
								...
								<div class="mb-1">
									...
									placeholder="contoh : 08123456789" value="<?= $data['pengajar_no_tlpn']; ?>" />
								</div>
								<div class="mb-1">
									<label class="form-label">Status</label>
									<select id="pengajar_status" name="pengajar_status" class="form-control">
									<option value="<?= $data['pengajar_status']; ?>"><?= $data['pengajar_status']; ?></option>
    ...
    $(document).on("click", "#ModalButtonSimpan", function() {
        if (validasi()) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= site_url('Pages/Data/Pengajar/Edit') ?>',
                data: data,
				beforeSend: function() {
